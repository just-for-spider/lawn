...
class XMDDZDPSpider(RedisSpider):
    ...
    def __init__(self, *args, **kwargs):
        #self.__injecturls()
        #self.__injectfailedurls()
        #self.__injectinvalidurls()
        pass
    ...
    def __injectinvalidurls(self, fname=''):
        host ='172.28.40.23'
        port = 6379
        password = 'Qbbigdata'
        with open('invalidurls_fromlog20170522') as f:
            while True:
                line = f.readline()
                line = line.strip()
                if not line:
